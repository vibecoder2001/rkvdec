...
static const RKMPP_PROFILE g_profiles[] = {
    { 0x3550, 0, RKMPP_CODEC_H264 | RKMPP_CODEC_HEVC | RKMPP_CODEC_VP9, 0x0100, RKMPP_PERSONALITY_RKVDEC2 },
    { 0x3550, 1, RKMPP_CODEC_H264 | RKMPP_CODEC_HEVC | RKMPP_CODEC_VP9, 0x0100, RKMPP_PERSONALITY_RKVDEC2 },
};
