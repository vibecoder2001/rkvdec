...
for %%P in (rkmpp_ccu rkiommu_vdec rkiommu_av1d rkvdec rkav1d) do (
  ...
  copy /Y "driver\%%P\ARM64\Debug\%%P\%%P.sys" "Z:\drivers-arm\rkvdec\%%P\" >nul
  copy /Y "driver\%%P\ARM64\Debug\%%P\%%P.cat" "Z:\drivers-arm\rkvdec\%%P\" >nul
  copy /Y "driver\%%P\ARM64\Debug\%%P\%%P.inf" "Z:\drivers-arm\rkvdec\%%P\" >nul
  copy /Y "driver\%%P\ARM64\Debug\%%P.pdb"     "Z:\drivers-arm\rkvdec\%%P\" >nul
